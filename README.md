...
Актуальный выпуск — **0.2.6**. Ручная сверка запускается двойным щелчком по любой сумме. Ширина меняется за правый край, шрифт — в настройках с живым предпросмотром.
...
1. Скачайте `KRS-AcquiringMonitor-0.2.6-setup.exe` из [GitHub Releases](https://github.com/jadieify-hub/krs-acquiring-monitor/releases).
...
1. Скачайте архив `KRS-AcquiringMonitor-0.2.6-win-x86.zip` из [GitHub Releases](https://github.com/jadieify-hub/krs-acquiring-monitor/releases).
...
powershell -NoProfile -ExecutionPolicy Bypass -File build/build-release.ps1 -Version 0.2.6
~~~
