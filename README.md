...
Текущая версия — **[0.2.11](https://github.com/jadieify-hub/krs-acquiring-monitor/releases/tag/v0.2.11)**. Добавлены сброс данных без потери оформления, диагностика, отдельная проверка обновлений и собственная иконка. Ширина по умолчанию уменьшена до 370 пикселей; сохранённая ширина не меняется. Исправлено завершение скрытого монитора установщиком. Сглаживание, шрифты, жирность, цвета и тихие запросы отчёта сохранены; сверка запускается двойным щелчком по сумме, ширина меняется за правый край.
...
Для первого перехода с 0.2.2 и старее рекомендуется запустить установщик 0.2.11 вручную: в старых версиях ещё нет периодической проверки и исправлений завершения процесса. Portable-версию обновляйте заменой файлов после выхода через трей.
